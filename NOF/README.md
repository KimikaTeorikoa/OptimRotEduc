...
This notebook was used to plot the results obtained with the previous notebook to generate in Figure 4 of the provided manuscript. Plots all the results in one run.
